...
Assert-True ($sidebarPagingPayload.Contains('window.setInterval(schedule, 500)')) 'Synthetic Threads should poll live working state while source lists are collapsed.'
